export default function About() {
  return (
    <>
      ...
      <p>To get started, click "Make Your Bible" in the menu. If you'd like to take the app for a test drive without uploading your own work, click <a href="book.txt">here</a> to download a public domain work to use instead.</p>
    </>
  )
}